...
export const metadata: Metadata = {
  ...
  description:
    'Bring a photo of your pet — leave with a finished painting. Adult, teen, and kids Paint Your Pet classes taught by Margaret Edmondson in Harvest, AL.',
}
      ...
      <section className="py-16 sm:py-20 bg-white/40 border-t border-charcoal/5">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 font-body text-base text-charcoal/75 leading-relaxed">
            BS Art Education (Murray State University), MFA in Painting (Savannah College of Art and Design). I&rsquo;ve been teaching painting since 2013 — from elementary classrooms to Saturday-morning Michaels classes to my own studio in Harvest, AL. Pets are my favorite subject; helping someone paint <em>their</em> pet is even better.
          </p>
